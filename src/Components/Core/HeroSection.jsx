...
const HeroSection = () => {
  return (
    <>
        ...
        <h2 className=" font-black text-[45px] sm:text-[80px] lg:text-[120px] text-white " >TO <span className="font-extrabold text-[45px] sm:text-[80px] lg:text-[120px] bg-gradient-to-r from-[#00FFA7] to-[#FFFF00] text-transparent bg-clip-text " >CHAINTECH</span></h2>
